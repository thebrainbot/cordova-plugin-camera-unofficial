...
cameraExport.getPicture = function(successCallback, errorCallback, options) {
    ...
    var args = [quality, destinationType, sourceType, targetWidth, targetHeight, encodingType, mediaType,
                allowEdit, correctOrientation, saveToPhotoAlbum, popoverOptions, cameraDirection, localOnly];
